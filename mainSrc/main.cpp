  ...
  void createGraphicsPipeline()
	{
	  ...
	  #ifdef ROOT_DIR
	  shaderLoc = ROOT_DIR;
	  shaderLoc.append("/shaders/");
	  #else
	  shaderLoc = "shaders/";
	  #endif
	  auto vertShaderCode = readFile(shaderLoc + "vert.spv");
	  auto fragShaderCode = readFile(shaderLoc + "frag.spv");
  ...
  void createSyncObjects()
	{
	  ...
	  for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; ++i)
		if (vkCreateSemaphore(device, &semaphoreInfo, nullptr, &imageAvailableSemaphores[i]) != VK_SUCCESS ||
		  ...
		  throw std::runtime_error("failed to create syncing objects! (semaphores/fences)");
	}
